                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.php" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="../images/elbena.png" alt="" height="50">
                                </span>
                                <span class="logo-lg">
                                    <img src="../images/elbena.png" alt="" height="50">
                                </span>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="assets/images/sabrine.jpg"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ml-1"><?php echo $donnees['nom']; ?></span>
