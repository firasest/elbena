<footer>
					<div class="container">
						<div class="row">
							<div class="col-sm-5">
								<ul class="list-group">
									<li class="list-group-item style-1 list-group-label">Nos Produits</li>
                                    <li class="list-group-item style-1"><a href="products.php#filter=*">Tous les produits</a></li>
                                    <li class="list-group-item style-1"><a href="products.php#filter=.rape">Patisserie Traditionnelle</a></li>
                                    <li class="list-group-item style-1"><a href="products.php#filter=.pate-presse">kunafeh</a></li>
                                    <li class="list-group-item style-1"><a href="products.php#filter=.pate-file">Baklewa</a></li>
                                    <li class="list-group-item style-1"><a href="products.php#filter=.pate-molle">Gateaux</a></li>
                                    <li class="list-group-item style-1"><a href="products.php#filter=.pate-fraiche">Chocolat</a></li>
                                    <li class="list-group-item style-1"><a href="products.php#filter=.a-base-alimentaire">Macaron</a></li>
						...
						<div class="row">
							<div class="col-sm-4 col-sm-offset-4 pad-v text-center">
								<img alt="logo" data-src="images/elbena.png" class="img-responsive1 lazy" srcset="images/elbena.png 1x, images/elbena.png 2x">
							</div>
						</div>
